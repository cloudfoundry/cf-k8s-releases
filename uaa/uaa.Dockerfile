# Build image
FROM --platform=$BUILDPLATFORM bellsoft/liberica-runtime-container:jdk-25.0.4_9-glibc AS builder
...
# Runtime image
FROM bellsoft/liberica-runtime-container:jre-25.0.4_9-slim-glibc
