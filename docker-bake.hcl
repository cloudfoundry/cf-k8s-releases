...
target "routing" {
  dockerfile = "routing/${component}.Dockerfile"
...
target "cf-networking" {
  dockerfile = "cf-networking/${component}.Dockerfile"
...
target "bosh-dns" {
  dockerfile = "bosh-dns/${component}.Dockerfile"
...
target "capi" {
  dockerfile = "capi/${component}.Dockerfile"
...
target "diego" {
  dockerfile = "diego/${component}.Dockerfile"
...
target "loggregator" {
  dockerfile = "loggregator/${component}.Dockerfile"
...
target "loggregator-agent" {
  dockerfile = "loggregator-agent/${component}.Dockerfile"
...
target "log-cache" {
  dockerfile = "log-cache/log-cache.Dockerfile"
...
target "fileserver" {
  dockerfile = "diego/fileserver.Dockerfile"
...
target "credhub" {
  dockerfile = "credhub/credhub.Dockerfile"
...
target "cflinuxfs4" {
  dockerfile = "cflinuxfs4/cflinuxfs4.Dockerfile"
...
target "nfs-volume" {
  dockerfile = "nfs-volume/${component}.Dockerfile"
